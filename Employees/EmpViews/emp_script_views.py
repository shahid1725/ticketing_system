...
def employee_addscript(request):
    if request.method=='POST':
        ...
        return redirect('employee_addscript')

    script = Script.objects.all()
    return render(request, 'EmpScript/employee_Script_Add.html', {'script': script})


@login_required(login_url='employee_signin')
def employee_editscript(request,id):
    ...
    if request.method == 'POST':
        ...
        return redirect('employee_addscript')
    return render(request, 'EmpScript/employee_Script_Edit.html', {'script': script})

#--------script listings are in this page-----------------------

def employee_leadattend(request,id):
    ...
    return render(request,'EmpLead/employee_Lead_Attend.html',{'script':script, 'tag':tag, 'trip':trip, 'lead': lead,
